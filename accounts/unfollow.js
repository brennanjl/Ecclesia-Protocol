...
export var unfollow = async(othersPublicID, privateKey) => {
    ...
    if (followerList.followers.includes(othersPublicID) == 0 ){
        throw 'User already does not follow this person'
    }
    const index = followerList.followers.indexOf(othersPublicID)
    if (index > -1) {
        followerList.followers.splice(index, 1)
    }
...
//unfollow('nYxifPxxc1LmxIq3RIMyLE2hnNZ5fdVZlDZ0f-5qa4U', key)